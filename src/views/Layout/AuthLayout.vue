    ...
    >
      ...
      <template>
        ...
        <b-navbar-nav class="align-items-lg-center ml-lg-auto">
          <b-nav-item to="/connectDatabase">
            <i class="fa fa-database"></i>
            <span class="nav-link-inner--text">Base de dados</span>
          </b-nav-item>
          <b-nav-item to="/login">
      ...
      <b-container>
        <b-row align-v="center" class="justify-content-xl-between">
          ...
          <b-col xl="6" class="col-xl-6">
            ...
            >
              <b-nav-item href="http://www.microton.com.br/" target="_blank">
                Home
              </b-nav-item>
              <b-nav-item
                href="http://www.microton.com.br/institucional_mvv.php"
                target="_blank"
              >
                Quem somos?
              </b-nav-item>
